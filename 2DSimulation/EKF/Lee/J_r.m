function [ result ] = J_r( delta )
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%   Function: Overloading function.
%   Method1:   I(3*3) - (1-cos(theta))*skew(delta)/norm(delta)^2 + ...
%             (norm(delta)-sin(norm(delta)))*skew(delta)^2/norm(delta)^3
%   Input1:    delta: 3*1 vector
...
%   Function1
    ...
    if(theta < 0.00000001)
        ...
        result = eye(3,3) - (1-cos(theta))*skew_3d(delta)/theta^2 + (theta-sin(theta))*skew_3d(delta)^2/norm(delta)^3;
    end
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%    
else
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%   Function2
    ...
    for i = 1 : N+1           % Set diagonal to J_r(s_theta)
        result(3*i-2:3*i,3*i-2:3*i) = J_r(s_theta);
    end
    for i = 1 : N
