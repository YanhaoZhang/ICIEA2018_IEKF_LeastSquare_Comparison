function [ Graph ] = PerformGO_1d( Graph )
    ...
    for i=1:Number_NodeTypes 
        ...
        for k=1:num_ids_thisType
            ...
            if ~isfield(Graph.Fixed.IDname,  thisNode_id)  
                ...
                Graph.Nodes.( ThisTypeName ).Values.( thisNode_id ) = update_state_1d( ThisTypeName, Graph.Nodes.( ThisTypeName ).Values.( thisNode_id ) , increment); 
            else
